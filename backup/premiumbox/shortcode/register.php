		...
		[form]
			...
			<div class="reg_div">
				<div class="reg_div_ins">
					...
					<div class="reg_line">
						<div class="checkbox"><input type="checkbox" name="rcheck" value="1" /> '. sprintf(__('I read and agree with <a href="%s" target="_blank">the terms and conditions</a>','pn'), '[toslink]' ) .'</div>
					</div>
