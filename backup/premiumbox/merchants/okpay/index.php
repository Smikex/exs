<?php
/*
title: [en_US:]Okpay[:en_US][ru_RU:]Okpay[:ru_RU]
description: [en_US:]Okpay merchant[:en_US][ru_RU:]мерчант Okpay[:ru_RU]
version: 1.3
*/
...
if(!class_exists('merchant_okpay')){
	class merchant_okpay extends Merchant_Premiumbox {
		...
		function myaction_merchant_status(){
			...
			$pay_purse = is_pay_purse($sSenderWalletID, $m_data, $m_id);
