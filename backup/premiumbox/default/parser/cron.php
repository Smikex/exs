					...
					foreach($valuts as $v_obj){
						...
						if($CharCode == 'CNY'){
							...
							if($on1 > 0){ 
								...
								$curs_parser[11]['curs2'] = is_my_money($on1 / $zn * $curs1); // RUB
								
								$curs1 = def_parser_curs($parsers, '12', 1);
								$curs_parser[12]['curs1'] = $curs1; // RUB
								$curs_parser[12]['curs2'] = is_my_money($curs1 / $on1 * $zn); // CNY	
							}				
	...
	*/
	...
	$arrs = array(
		...
		array(
			'id1' => 317,
			'id2' => 318,
			'url' => 'https://www.bitstamp.net/api/v2/ticker/ltcbtc/'
		),
		array(
			'id1' => 319,
			'id2' => 320,
		...
		array(
			'id1' => 329,
			'id2' => 330,
			'url' => 'https://www.bitstamp.net/api/v2/ticker/bchbtc/'
		),	
	);
	...
	foreach($arrs as $arr){
			...
			if(!$curl['err']){
				...
				if(is_object($out)){
					...
					if(isset($arr['id2'])){
						...
						$ck2 = is_my_money($out->$key2);
							
						$curs2 = def_parser_curs($parsers, $arr['id2'], 1000);
						$ck2 = is_my_money($curs2 / $ck2);
						if($ck2){
 	...
 	// if(is_isset($work_parser,301) == 1 or is_isset($work_parser,302) == 1){
		...
		// if(!$curl['err']){
			...
			// if(!$key){ $key='low'; }
			// $key2 = trim(is_isset($config_parser, 302));
			// if(!$key2){ $key2='low'; }
			// if(is_object($out) and isset($out->$key) and isset($out->$key2)){
				
				// $ck1 = is_my_money($out->$key);
				// if($ck1){
					// $curs1 = def_parser_curs($parsers, '301', 1);
					// $curs_parser[301]['curs1'] = $curs1; 
					// $curs_parser[301]['curs2'] = $ck1 * $curs1;	
				// }
				
				// $ck2def = is_my_money($out->$key2);
				// $curs2 = def_parser_curs($parsers, '302', 1000);
				// if($curs2 and $ck2def){
					// $ck2 = is_my_money($curs2 / $ck2def);
					// $curs_parser[302]['curs1'] = $curs2; 
					// $curs_parser[302]['curs2'] = $ck2;
				// }
	...
	$arrs = array(
		array(
			'id1' => 351,
			'id2' => 352,
			'url' => 'https://wex.nz/api/2/btc_usd/ticker/'
		),	
		array(
			'id1' => 353,
			'id2' => 354,
			'url' => 'https://wex.nz/api/2/btc_rur/ticker'
		),		
		array(
			'id1' => 355,
			'id2' => 356,
			'url' => 'https://wex.nz/api/2/btc_eur/ticker'
		),	
		array(
			'id1' => 359,
			'id2' => 360,
			'url' => 'https://wex.nz/api/2/ltc_usd/ticker'
		),
		array(
			'id1' => 361,
			'id2' => 362,
			'url' => 'https://wex.nz/api/2/ltc_eur/ticker'
		),
		array(
			'id1' => 363,
			'id2' => 364,
			'url' => 'https://wex.nz/api/2/ltc_rur/ticker'
		),
		array(
			'id1' => 365,
			'id2' => 366,
			'url' => 'https://wex.nz/api/2/ltc_btc/ticker'
		),
		array(
			'id1' => 371,
			'id2' => 372,
			'url' => 'https://wex.nz/api/2/dsh_btc/ticker'
		),		
		array(
			'id1' => 373,
			'id2' => 374,
			'url' => 'https://wex.nz/api/2/eth_btc/ticker'
		),
		array(
			'id1' => 375,
			'id2' => 376,
			'url' => 'https://wex.nz/api/2/eth_usd/ticker'
		),
		array(
			'id1' => 377,
			'id2' => 378,
			'url' => 'https://wex.nz/api/2/eth_ltc/ticker'
		),
		array(
			'id1' => 379,
			'id2' => 380,
			'url' => 'https://wex.nz/api/2/eth_rur/ticker'
		),
		array(
			'id1' => 381,
			'id2' => 382,
			'url' => 'https://wex.nz/api/2/usd_rur/ticker'
		),	
		array(
			'id1' => 383,
			'id2' => 384,
			'url' => 'https://wex.nz/api/2/eur_rur/ticker'
		),
		array(
			'id1' => 385,
			'id2' => 386,
			'url' => 'https://wex.nz/api/2/eur_usd/ticker'
		),
		array(
			'id1' => 367,
			'url' => 'https://wex.nz/api/2/nvc_btc/ticker'
		),
		array(
			'id1' => 368,
			'url' => 'https://wex.nz/api/2/nmc_btc/ticker'
		),
		array(
			'id1' => 369,
			'url' => 'https://wex.nz/api/2/nvc_usd/ticker'
		),	
		array(
			'id1' => 370,
			'url' => 'https://wex.nz/api/2/nmc_usd/ticker'
		),
		array(
			'id1' => 388,
			'id2' => 389,
			'url' => 'https://wex.nz/api/2/dsh_usd/ticker'
		),
		array(
			'id1' => 390,
			'id2' => 391,
			'url' => 'https://wex.nz/api/2/dsh_rur/ticker'
		),
		array(
			'id1' => 392,
			'id2' => 393,
			'url' => 'https://wex.nz/api/2/dsh_eur/ticker'
		),	
		array(
			'id1' => 394,
			'id2' => 395,
			'url' => 'https://wex.nz/api/2/bch_usd/ticker'
		),	
		array(
			'id1' => 396,
			'id2' => 397,
			'url' => 'https://wex.nz/api/2/bch_rur/ticker'
		),
		array(
			'id1' => 398,
			'id2' => 399,
			'url' => 'https://wex.nz/api/2/bch_eur/ticker'
		),
		array(
			'id1' => 800,
			'id2' => 801,
			'url' => 'https://wex.nz/api/2/bch_btc/ticker'
		),
		array(
			'id1' => 802,
			'id2' => 803,
			'url' => 'https://wex.nz/api/2/bch_ltc/ticker'
		),
		array(
			'id1' => 804,
			'id2' => 805,
			'url' => 'https://wex.nz/api/2/bch_eth/ticker'
		),
		array(
			'id1' => 806,
			'id2' => 807,
			'url' => 'https://wex.nz/api/2/bch_dsh/ticker'
		),
		array(
			'id1' => 808,
			'id2' => 809,
			'url' => 'https://wex.nz/api/2/zec_btc/ticker'
		),
		array(
			'id1' => 810,
			'id2' => 811,
			'url' => 'https://wex.nz/api/2/zec_usd/ticker'
		),		
	);
	...
	$curl = get_curl_parser('http://api.exmo.me/v1/ticker/', '', 'parser', 'exmo');
	if(!$curl['err']){
