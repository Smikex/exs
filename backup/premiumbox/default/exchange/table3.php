...
global $wpdb, $premiumbox;
	...
	if(!isset($naps->id)){
		...
		if(isset($naps->id)){			
			...
			<div class="xtl_table_body">
				...
				<div class="xtl_left_col">';
					...
					$tbl3_leftcol_data = apply_filters('tbl3_leftcol_data', $tbl3_leftcol_data, $cdata, $vd1, $vd2, $naps, $user_id, $post_sum);			
				...
				<div class="xtl_right_col">';
					...
					$tbl3_rightcol_data = apply_filters('tbl3_rightcol_data', $tbl3_rightcol_data, $cdata, $vd1, $vd2, $naps, $user_id, $post_sum);			
		...
		$naps_id = intval(is_isset($naps,'id'));
	
		$temp .='	
		<div class="xtl_submit_wrap">	
			<a href="'. get_exchange_link(is_isset($naps, 'naps_name')) .'" class="xtl_submit js_exchange_link '. $link_class .'" id="js_submit_button" data-naps="'. $naps_id .'">'. __('Exchange','pn') .'</a>
				<div class="clear"></div>
		</div>';	
