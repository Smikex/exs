...
global $wpdb, $premiumbox;	
	...
	$options = array(
		'rateconv','tablenot','tableselect','tablevid','exch_method', 'flysum', 'admin_mail',
		'an1_hidden','an2_hidden', 'exch_exsum','allow_dev','ipuserhash', 'mini_navi', 'mhead_style',
		'm_ins','mp_ins','hidecurrtype','enable_step2','avsumbig',
	);
