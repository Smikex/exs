...
add_filter('bid_instruction_tags', 'napsemail_bid_instruction_tags', 1000, 5);
function napsemail_bid_instruction_tags($instruction, $item, $naps, $vd1, $vd2){
global $premiumbox;
...
add_filter('merchant_formstep_after','napsemail_merchant_formstep_after', 9999, 4);
