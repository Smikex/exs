...
?>	
<style>
.column-yourcb{ width: 260px!important; }
</style>
...
global $wpdb;
	...
	if($column_name == 'yourcb'){
		...
		<div style="width: 260px;">
			<select name="masschange['. $item->id .']" autocomplete="off" id="naps_masschange_'. $item->id .'" class="naps_masschange" style="width: 260px; display: block; margin: 0 0 10px;"> 
		';
			$enable = 0;
		...
		$html .= '
			...
			<div id="the_naps_masschange_'. $item->id .'" '. $style .'>
				<input type="text" name="mnums1['. $item->id .']" style="width: 100px; float: left; margin: 2px 5px 0 0;" value="'. pn_strip_input($item->mnums1) .'" />
				<div style="float: left; margin: 5px 10px 0 10px;">=></div>
				<input type="text" name="mnums2['. $item->id .']" style="width: 100px; float: left; margin: 2px 5px 0 0;" value="'. pn_strip_input($item->mnums2) .'" />				
...
?>
	...
	<tr>
		...
		<td>
			<div class="premium_wrap_standart">
				<input type="text" name="mnums1" value="<?php echo pn_strip_input(is_isset($data, 'mnums1'));?>" />										
			</div>			
		</td>
		<td>
			<div class="premium_wrap_standart">
				<input type="text" name="mnums2" value="<?php echo pn_strip_input(is_isset($data, 'mnums2'));?>" />											
			</div>	
		</td>
	</tr>
<script type="text/javascript">
