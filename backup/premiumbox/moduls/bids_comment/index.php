...
/*
title: [ru_RU:]Комментарии к заявкам[:ru_RU][en_US:]Comments for orders[:en_US]
description: [ru_RU:]Комментарии к заявкам для администратора и клиентов[:ru_RU][en_US:]Comments for orders for administrator and users[:en_US]
version: 1.1
