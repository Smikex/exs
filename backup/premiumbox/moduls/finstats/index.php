...
/*
title: [ru_RU:]Финансовая статистика (от суммы обмена)[:ru_RU][en_US:]Financial statistics (from amount of exchange)[:en_US]
description: [ru_RU:]Финансовая статистика (от суммы обмена)[:ru_RU][en_US:]Financial statistics (from amount of exchange)[:en_US]
version: 1.1
