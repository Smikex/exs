			...
			<div class="topbar">
				...
				<?php if($change['telegram']){ ?>
					<div class="topbar_icon telegram">
						<a href="https://t.me/<?php echo pn_strip_input($change['telegram']); ?>"><?php echo pn_strip_input($change['telegram']); ?></a>
					</div>		
				<?php } ?>

				<?php if($change['viber']){ ?>
					<div class="topbar_icon viber">
						<a href="viber://chat?number=<?php echo pn_strip_input($change['viber']); ?>"><?php echo pn_strip_input($change['viber']); ?></a>
					</div>		
				<?php } ?>

				<?php if($change['whatsup']){ ?>
					<div class="topbar_icon whatsup">
						<a href="https://api.whatsapp.com/send?phone=<?php echo pn_strip_input($change['whatsup']); ?>"><?php echo pn_strip_input($change['whatsup']); ?></a>
					</div>		
				<?php } ?>

				<?php if($change['jabber']){ ?>
					<div class="topbar_icon jabber">
						<a href="xmpp:<?php echo pn_strip_input($change['jabber']); ?>"><?php echo pn_strip_input($change['jabber']); ?></a>
					</div>		
				<?php } ?>				
