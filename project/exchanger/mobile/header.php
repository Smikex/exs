				...
				<div class="slide_window_title"><?php _e('Contacts','pntheme'); ?></div>
					...
					<div class="cmenu">
						<ul>
							...
							<li class="telegram">
								<span><a href="https://t.me/<?php echo pn_strip_input($change['telegram']); ?>"><?php echo pn_strip_input($change['telegram']); ?></a></span>
							</li>
							<?php } ?>
							<?php if($change['viber']){ ?>
							<li class="viber">
								<span><a href="viber://chat?number=<?php echo pn_strip_input($change['viber']); ?>"><?php echo pn_strip_input($change['viber']); ?></a></span>
							</li>		
							<?php } ?>
							<?php if($change['whatsup']){ ?>
							<li class="whatsup">
								<span><a href="https://api.whatsapp.com/send?phone=<?php echo pn_strip_input($change['whatsup']); ?>"><?php echo pn_strip_input($change['whatsup']); ?></a></span>
							</li>		
							<?php } ?>

							<?php if($change['jabber']){ ?>
							<li class="jabber">
								<span><a href="xmpp:<?php echo pn_strip_input($change['jabber']); ?>"><?php echo pn_strip_input($change['jabber']); ?></a></span>
							</li>		
							<?php } ?>				
							
							<?php if($change['skype']){ ?>
							<li class="skype">
								<span><a href="skype:<?php echo pn_strip_input($change['skype']); ?>?add" title="<?php _e('Add to skype','pntheme'); ?>"><?php echo pn_strip_input($change['skype']); ?></a></span>
							</li>		
							<?php } ?>
